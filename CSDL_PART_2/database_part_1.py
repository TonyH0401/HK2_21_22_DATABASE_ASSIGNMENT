# -*- coding: utf-8 -*-
"""DATABASE_PART_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11_fhNjZiLPl7GspXif_O1cynis4DtSTP
"""
...
if __name__ == "__main__":
  input_link = readInputFile('/content/drive/MyDrive/Colab Notebooks/Input1.txt')
  ...
  output_link = ('/content/drive/MyDrive/Colab Notebooks/Output1.txt')
  writeFile(output_link, data)

demo_list = [['MAVN','ALO'], ['HOTENNV'], 'NAMSINH', 'GIOITINH', 'LUONG', 'DIACHI']

 x = [y for y in demo_list if isinstance(y, list)]
 print(x)